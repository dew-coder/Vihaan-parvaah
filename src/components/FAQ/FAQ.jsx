...
const FaqItem = ({ question, answer }) => {
  ...
  return (
    <div className=" rounded-lg mb-4">
      <button
        className="w-full text-left py-2 px-4 font-bold  text-black hover:bg-black hover:text-white focus:outline-none"
      ...
      {isOpen && (
        <div className="p-4  w-full">
          <p className="text-gray-500 w-4/5  text-wrap">{answer}</p>
        </div>
      )}
    </div>
  );
...
const FAQ = () => {
  ...
  return (
    <div className="my-10 mt-32 flex flex-col w-full">
      <h2 className="px-32 text-5xl  font-bold text-black mb-8">
